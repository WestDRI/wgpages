...
### Scenario 1: two users on a shared cluster filesystem working with the same dataset
...
### Scenario 3: (if we have time)  managing multiple Git repos under one dataset
